...
const HeroSection: React.FC = () => {
  return (
    <section className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-16 lg:pb-24 bg-gradient-to-br from-primary-800 to-primary-600 text-white">
      <div className="absolute inset-0 bg-[url(https://cdn.properties.emaar.com/wp-content/uploads/2024/08/VEO.jpg)] bg-cover bg-center opacity-40"></div>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-x0,5 sm:text-2xl lg:text-2x1 mb-4 font-light">
            Get 20+ New Members Every Month Without Spending a Dime on Ads
          </p>

          {/* YouTube Video Container - JAVÍTOTT IFRAME */}
          <div className="mb-5 w-full sm:w-11/12 md:w-4/5 lg:w-8/12 xl:w-10/12 mx-auto aspect-video bg-black bg-opacity-30 rounded-xl overflow-hidden">
            <iframe
