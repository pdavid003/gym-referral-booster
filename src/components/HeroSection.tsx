    ...
    <section className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-24 bg-gradient-to-br from-primary-800 to-primary-600 text-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-4xl font-bold mb-2 leading-tight">
            Turn Your Gym Into a <span className="text-accent-300">Referral Machine</span>
          </h1>
          <p className="text-x0,5 sm:text-2xl lg:text-3xl mb-7 font-light">
            Get 20+ New Members Every Month Without Spending a Dime on Ads
          </p>

          {/* YouTube Video Container - JAVÍTOTT IFRAME */}
          <div className="mb-8 w-3/4 mx-auto aspect-video bg-black bg-opacity-30 rounded-xl overflow-hidden">
            <iframe
          ...
          <div className="mb-12">
            <a
              ...
              className="inline-block bg-accent-300 hover:bg-accent-400 text-primary-900 font-bold py-4 px-10 rounded-full text-lg sm:text-xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl"
